        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container mx-auto p-4 max-w-lg">
                    <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Buat Driver Baru</h1>
                    ...
                    <form action="{{ route('drivers.store') }}" method="POST" class="space-y-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" name="phone" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="{{old('license_plate', $vehicle->license_plate ?? '') }}" required>
                        </label>
